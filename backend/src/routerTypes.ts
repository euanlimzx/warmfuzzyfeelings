...
export const NatJoshSecondCardFormResponseSchema = z.object({
  cardUUID: z.string().uuid(),
  responseUUID: z.string().uuid(),
  memoryResponse: z.string().min(1),
  descriptionResponse: z.string().min(1),
});
export type NatJoshSecondCardFormResponse = z.infer<
  typeof CardFormResponseSchema
>;
